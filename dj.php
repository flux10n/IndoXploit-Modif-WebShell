...
<a href="?<?php echo "y=".$pwd; ?>&amp;x=port-sc">Port</a>
...
<a href="?<?php echo "y=".$pwd; ?>&amp;x=tutor">Tutorial</a>
...
elseif(isset($_GET['x']) && ($_GET['x'] == 'about'))
	...
	<br><br><font size="5" color="#00ff00">.: Last :.</font></center><center>
<marquee direction="up" scrollamount="2" bgcolor="" width="250" height="40"><center>
<p><b><font size="3" color="#00ff00">=[ People Unknown ]=<br><br>
1<br>
	2<br>
		3<br>
			4<br>
